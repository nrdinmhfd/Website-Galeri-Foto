...
<body>
    ...
    <div class="container mt-3">
        ...
        Album :
        <?php
        $album = mysqli_query($conection, "SELECT * FROM album WHERE userid='$userid'");
        ...
        <div class="row">
            ...
            if (isset($_GET['albumid'])) {
                ...
                $query = mysqli_query($conection, "SELECT * FROM foto WHERE userid='$userid' AND albumid='$albumid'");
                ...
                $query = mysqli_query($conection, "SELECT * FROM foto WHERE userid='$userid'");
                while ($data = mysqli_fetch_array($query)) {
                ?>
