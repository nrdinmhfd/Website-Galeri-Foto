...
<body>
  ...
  <div class="container mt-3">
    ...
    <div class="row">
      ...
      <?php
      $query = mysqli_query($conection, "SELECT * FROM foto INNER JOIN user ON foto.userid=user.userid INNER JOIN album ON foto.albumid=album.albumid");
          ...
          <a type="button" data-bs-toggle="modal" data-bs-target="#komentar<?php echo $data['fotoid'] ?>">
            ...
            <div class="card mb-2">
              ...
              <div class="card-footer text-center">
                ...
                <?php }
                $like = mysqli_query($conection, "SELECT * FROM likefoto WHERE fotoid='$fotoid'");
                ...
                <?php
                $jmlkomen = mysqli_query($conection, "SELECT * FROM komentarfoto WHERE fotoid='$fotoid'");
                    ...
                    <div class="col-md-4">
                      <div class="m-2">
                        <div class="overflow-auto">
                          ...
                          <?php
                          $fotoid = $data['fotoid'];
                          $komentar = mysqli_query($conection, "SELECT * FROM komentarfoto INNER JOIN user ON komentarfoto.userid=user.userid  WHERE komentarfoto.fotoid='$fotoid'");
